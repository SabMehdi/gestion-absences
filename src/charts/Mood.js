  ...
  return (
    <div>
      ...
      <HeatMap
        ...
        squares
        height={60} // Augmentez la hauteur des cellules
        ...
        xLabelsPos="bottom" // Position des étiquettes de l'axe X en bas
        xLabelsStyle={{ fontSize: '12px', fontWeight: 'bold', transform: 'rotate(-45deg)', whiteSpace: 'nowrap' }} // Rotation des étiquettes de l'axe X
      />
    </div>
  );
}
